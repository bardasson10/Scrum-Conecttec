    ...
    try:
        ...
        if data:
            ...
            for apontamento in data:
                apontamento["beginning"] = datetime.strptime(
                    apontamento["beginning"], "%Y-%m-%dT%H:%M:%S.%fZ"
                )
                apontamento["ending"] = datetime.strptime(
                    apontamento["ending"], "%Y-%m-%dT%H:%M:%S.%fZ"
                )
                ...
                # Formatar data
                apontamento["beginning"] = datetime.strftime(
                    apontamento["beginning"], "%d/%m/%Y %H:%M"
                )
                apontamento["ending"] = datetime.strftime(
                    apontamento["ending"], "%H:%M"
                )
